...
Анимации отдаются с **jsDelivr** (тег `animations-v4`): в списке поиска — статичный JPEG, после выбора — MP4.
...
|-----|-----|
| Код бота | ветка `main` |
| MP4 анимации | ветка `animations` + тег `animations-v4` |
...
./scripts/publish-animations.sh animations-v4
```
